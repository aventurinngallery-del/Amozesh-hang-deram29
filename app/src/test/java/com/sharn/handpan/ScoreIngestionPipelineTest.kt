...
import com.sharn.handpan.model.AdaptationApproval
import com.sharn.handpan.model.DetectedScoreFormat
import com.sharn.handpan.model.FormatDetectionResult
import com.sharn.handpan.model.ImageScoreSource
import com.sharn.handpan.model.ImportedScoreRecord
import com.sharn.handpan.model.PdfPage
import com.sharn.handpan.model.PdfRasterizationResult
import com.sharn.handpan.model.PdfScoreSource
import com.sharn.handpan.model.ScoreFormatDetector
...
import com.sharn.handpan.model.scoreSourceFromImportableBytes
...
class ScoreIngestionPipelineTest {
    ...
    fun approvedPartialAdaptationPersistsPlayableExerciseAndApprovalSurvivesReload() = runBlocking {
        ...
        assertEquals(
            ...
            com.sharn.handpan.data.local.ImportedScoreEntity.fromRecord(store.record!!).toRecord().adaptationApproval
        )
    }
    ...
    private class MemoryStore : ScoreIngestionStore {
        ...
        override suspend fun saveImportedExercise(record: ImportedScoreRecord, pattern: com.sharn.handpan.model.HandpanPattern) {
            this.record = record
    ...
    private class FakePdfScoreSource(sourceId: String) : PdfScoreSource, Closeable {
        override val identity = com.sharn.handpan.model.ScoreSourceIdentity(sourceId, "pdf-hash", com.sharn.handpan.model.MusicalProvenance(sourceId))
