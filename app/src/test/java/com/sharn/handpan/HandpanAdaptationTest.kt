...
import com.sharn.handpan.model.AdaptationStatus
import com.sharn.handpan.model.HandpanAdaptationSolver
import com.sharn.handpan.model.HandpanArrangement
...
import com.sharn.handpan.model.StructuredScoreImporter
import com.sharn.handpan.model.SymbolicImportError
import com.sharn.handpan.model.SymbolicImportResult
import com.sharn.handpan.model.AdaptationQualityCalculator
import com.sharn.handpan.model.SymbolicPlaybackTiming
...
class HandpanAdaptationTest {
    ...
    private fun event(id: String, midi: Int, beat: Double = 0.0, voice: String? = null, hand: com.sharn.handpan.model.PlayingHand? = null) =
    ...
    fun importerBoundaryRejectsInvalidSourceAndDefersRealParserSelection() {
        val emptyMidi = com.sharn.handpan.model.MidiScoreImporter().import("", "source")
        ...
        val invalidXml = com.sharn.handpan.model.MusicXmlScoreImporter().import("plain text", "source")
        ...
        val structured = com.sharn.handpan.model.StructuredScoreImporter().importScore(
            SymbolicScore(
    ...
    fun solverIsDeterministicAndProjectionPreservesTimingAndVelocity() {
        val first = HandpanAdaptationSolver.adapt(timeline(event("e1", 62)), com.sharn.handpan.model.AdaptationRequest(
            com.sharn.handpan.model.InstrumentProfile.DEFAULT_D_KURD_9
        ))
        val second = HandpanAdaptationSolver.adapt(timeline(event("e1", 62)), com.sharn.handpan.model.AdaptationRequest(
            com.sharn.handpan.model.InstrumentProfile.DEFAULT_D_KURD_9
        ))
    ...
    fun playbackScalingDoesNotMutateCanonicalTimelineAndMetricsAreZeroSafe() {
        ...
        val quality = AdaptationQualityCalculator.calculate(
            HandpanAdaptationSolver.adapt(canonical, com.sharn.handpan.model.AdaptationRequest(
                com.sharn.handpan.model.InstrumentProfile.DEFAULT_D_KURD_9
            ))
        )
    ...
    fun unavailablePitchIsExplicitAndTransposeAndOctaveAreIndependent() {
        val unavailable = HandpanAdaptationSolver.adapt(timeline(event("missing", 61)), com.sharn.handpan.model.AdaptationRequest(
            com.sharn.handpan.model.InstrumentProfile.DEFAULT_D_KURD_9
        )).decisions.single()
        ...
        val transposed = HandpanAdaptationSolver.adapt(timeline(event("transpose", 62)), com.sharn.handpan.model.AdaptationRequest(
            com.sharn.handpan.model.InstrumentProfile.DEFAULT_D_KURD_9, transposeSemitones = 2
        )).decisions.single()
        ...
        val octave = HandpanAdaptationSolver.adapt(timeline(event("octave", 50)), com.sharn.handpan.model.AdaptationRequest(
            com.sharn.handpan.model.InstrumentProfile.DEFAULT_D_KURD_9, octaveShift = 1
        )).decisions.single()
    ...
    fun chordReductionPreservesMelodyAndReportsSustainAndHandConstraints() {
        val chord = HandpanAdaptationSolver.adapt(
            ...
            com.sharn.handpan.model.AdaptationRequest(com.sharn.handpan.model.InstrumentProfile.DEFAULT_D_KURD_9, maxSimultaneousNotes = 1)
        )
        ...
        val sustained = HandpanAdaptationSolver.adapt(timeline(event("long", 62)), com.sharn.handpan.model.AdaptationRequest(
            com.sharn.handpan.model.InstrumentProfile.DEFAULT_D_KURD_9, maxSustainBeats = 0.25
        )).decisions.single()
        ...
        val explicit = HandpanAdaptationSolver.adapt(timeline(event("right", 64, hand = com.sharn.handpan.model.PlayingHand.RIGHT)), com.sharn.handpan.model.AdaptationRequest(
            com.sharn.handpan.model.InstrumentProfile.DEFAULT_D_KURD_9
        )).decisions.single()
        assertEquals(com.sharn.handpan.model.HandAssignmentStatus.EXPLICIT, explicit.handStatus)
    }
    ...
    fun repeatedNoteConstraintIsExplicit() {
        val arrangement = HandpanAdaptationSolver.adapt(
            ...
            com.sharn.handpan.model.AdaptationRequest(com.sharn.handpan.model.InstrumentProfile.DEFAULT_D_KURD_9, minimumRepeatedNoteIntervalBeats = 0.5)
        )
